...
public class C01_tekrar extends TestBase {
    ...
    public void test01(){
        ...
        System.out.println("Başlıktaki Bilgiler: "+headerElementi.getText());
        ...
        System.out.println("===============");
        WebElement bodyElement= driver.findElement(By.xpath("//div[@class='rt-tbody']"));
